...
create table stock_watchlist_analysis_snapshot (
...
create table stock_position (position_id bigint not null auto_increment,user_id bigint not null,stock_code varchar(6) not null,stock_name varchar(50),market char(2) not null,cost_price decimal(16,2) not null,quantity bigint not null,create_by varchar(64),create_time datetime,update_by varchar(64),update_time datetime,primary key(position_id),unique key uk_position_user_code(user_id,stock_code)) engine=InnoDB default charset=utf8mb4;
